...
// Teto de segurança para a opção "sem limite" (sem ele, a busca pagina a
// tabela inteira e trava a aba). Aplicado num único ponto
// (fetchEventRowsWithTimeFallback); quando atingido, o resultado truncado
// PRECISA ficar visível (TruncationNotice) — ver
